...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Power_OUT1_EN_Pin|Power_5V_EN_Pin|RS485_DIR1_Pin|LED_Pin
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PC1 PCPin */
  GPIO_InitStruct.Pin = Power_OUT1_EN_Pin|Power_5V_EN_Pin|RS485_DIR1_Pin|LED_Pin
